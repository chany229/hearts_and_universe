...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference('Info.count') do
      post infos_url, params: { info: { desc: @info.desc, event_id: @info.event_id, keyword_id: @info.keyword_id } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { desc: @info.desc, event_id: @info.event_id, keyword_id: @info.keyword_id } }
