...
#   }
set :application, 'hearts'
set :stage, :production
set :repo_url, 'git@github.com:chany229/hearts_and_universe.git'
set :branch, 'master'
...
set :nginx_server_name, "shifangliushi.work 103.146.230.196"